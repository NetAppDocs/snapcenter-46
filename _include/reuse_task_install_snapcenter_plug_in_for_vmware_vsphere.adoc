...
To configure the CA Certificate with SnapCenter Plug-in for VMware vSphere, see hhttps://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere[Create or import SSL certificate^].
